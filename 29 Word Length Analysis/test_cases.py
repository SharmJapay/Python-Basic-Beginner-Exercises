...
def test_input_string_list_valid_number_list(monkeypatch):
...
def test_input_string_list_invalid_input_list(monkeypatch, capsys):
    """Test that the loop retries on bad input (some items are empty) and succeeds on a valid number list."""

    # Arrange: Simulate typing 'hello, asd, , , 667', then ' , , , ' and then '1, 2, 3, 4, 5'
    inputs = iter(["hello, asd, , , 667", " , , , ", "1, 2, 3, 4, 5"])
