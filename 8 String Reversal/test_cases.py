...
@pytest.mark.parametrize(
    "text, expected",
    [
        # Case 1: "Hello" -> Should return "olleH"
        ("Hello", "olleH"),
        # Case 2: "Hello World!" -> Should return "!dlroW olleH"
        ("Hello World!", "!dlroW olleH"),
        # Case 3: "Python" -> Should return "nohtyP"
        ("Python", "nohtyP"),
        # Case 4: "Python is fun" -> Should return "nuf si nohtyP"
